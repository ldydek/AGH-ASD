...
# tablicę. Warto zauważyć, iż po każdej iteracji na końcu tablicy tworzy się podzbiór elementów już posortowanych. Po
# pierwszej będzie to największa liczba, po drugiej będzie to druga największa liczba itd. Ta sztuczka pozwoli
# zredukować ilość operacji, lecz złożoność algorytmu zostaje nadal O(n^2) - z dokładnością do stałej.
